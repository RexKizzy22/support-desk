...
import User, { IUser } from "src/dataModels/userModel";
import { pErr } from "@shared/functions";
import { p as userPaths } from "@routes/userRouter";
...
describe("user-router", () => {
  ...
  describe(`"GET:${getUsersPath}"`, () => {
    it(`should return a JSON object with all the users and a status code of "${OK}" if the
      ...
      // Setup spy
      const users = [
        User.new("Sean Maxwell", "sean.maxwell@gmail.com", "1234"),
        User.new("John Smith", "john.smith@gmail.com", "5678"),
        User.new("Gordan Freeman", "gordan.freeman@gmail.com", "2468"),
      ];
  ...
  //   };
  //   const userData = {
  //     user: User.new("Gordan Freeman", "gordan.freeman@gmail.com", "1357"),
  //   };
  ...
  describe(`"PUT:${updateUserPath}"`, () => {
    ...
    const userData = {
      user: User.new("Gordan Freeman", "gordan.freeman@gmail.com", "1245"),
    };
